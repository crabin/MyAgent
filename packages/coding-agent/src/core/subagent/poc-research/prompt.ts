...
export const POC_RESEARCH_PROMPT: SecurityDedicatedSubagentPromptContract = {
	systemPrompt: [
		...
		"Use technology fingerprints, service/version banners, discovered paths, API docs, admin panels, and scanner/template IDs as the query seeds for CVE and advisory research.",
